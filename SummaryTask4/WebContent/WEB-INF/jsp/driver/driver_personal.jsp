    ...
    <tr>
        <td class="content">
            ...
            <div style="margin-bottom: 15px; margin-top: 10px; color: grey">
                <i><fmt:message key="driverPersonalAllTrips"/>:</i>
            </div>
                            ...
                            <tr>
                                ...
                                <form name="send-request" action="controller" method="post">
                                    <td class="text-center">
                                        ...
                                        <input type="hidden" name="command" value="tripCompleted"/>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-default" type="submit"
                                                name="tripId" value=${bean.id}>
                                            <fmt:message key="buttonTripComplete"/>
                                        </button>
                                    </td>
                                </form>
                            </tr>
